...
const Toast = ({ message, type = 'info', duration = 3000, onClose }) => {
  ...
  return (
    <div 
      className={`
        fixed bottom-4 right-4 flex items-start p-4 mb-4 max-w-sm rounded-lg border
    ...
    >
      <div className="flex items-center">
        ...
        <button
          type="button"
          className="ml-auto -mx-1.5 -my-1.5 rounded-lg p-1.5 hover:bg-white/25 inline-flex h-8 w-8"
          aria-label="Close"
          onClick={() => {
            setVisible(false);
